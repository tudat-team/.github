...
This is the Github landing page for the TU Delft Astrodynamics Toolkit - or Tudat - project. Tudat is a powerful toolbox for research and education in numerical orbit propagation, state and parameter estimation, and mission design. The project originated at, and is managed by, staff and students at TU Delft, with an ever growing network of users, developers and alumni. The bulk of the functionality is written in C++ (Tudat), but the typical user interface is in Python (Tudatpy), which links to the Tudat core code.
...
- [tudatpy](https://github.com/tudat-team/tudatpy) The repository with the code of our project (in C++), unit tests for our code, and code to generate the Python exposure (using [pybind11](https://github.com/pybind/pybind11)), as well as a limited set of Python native code. 
